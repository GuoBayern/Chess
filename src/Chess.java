...
public class Chess{
    public static void main(String[] args){
        new ChessMainFrame("中国象棋：Design By Guo");
    }
}
...
class ChessMainFrame extends JFrame implements ActionListener,MouseListener,Runnable{
    ...
    private JLabel[] play = new JLabel[32];
    ...
    private boolean chessManClick;

    private int chessPlayClick=2;

    private Thread tmain;

    private static int Man,i;
    ...
    class ChessRule {
        ...
        /**卒吃棋规则*/
        void armsRule(JLabel play1, JLabel play2){
            //向右走
        ...
        /**将移动规则*/
        void willRule(int Man, JLabel play, JLabel playQ[], MouseEvent me){
            //向上
        ...
        void willRule(int Man, JLabel play, JLabel playTake, JLabel playQ[]){
            //当前状态
            boolean will = false;
